...
class Options_Framework_Admin {
	...
	function enqueue_admin_styles( $hook ) {
		...
		wp_enqueue_style( 'optionsframework', plugin_dir_url( __DIR__ ) . 'css/optionsframework.css', array(), Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'options-custom', plugin_dir_url( __DIR__ ) . 'js/options-custom.js', array( 'jquery', 'wp-color-picker' ), Options_Framework::VERSION );
